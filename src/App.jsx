        ...
        <div style={{...card,padding:"32px 22px"}}>
          ...
          <div style={{background:"rgba(255,183,197,0.1)",borderRadius:14,padding:"16px 14px",marginBottom:12,border:"1px solid rgba(255,183,197,0.2)"}}>
            ...
            <p style={{fontSize:13,color:"#5A3050",margin:0,lineHeight:1.7}}>
              {{
                SPEC:  insight.bestV>=60
                  ?"ステータス面での評価がとても高く、お相手から注目されやすいポジションです。この強みを最大限に活かしましょう。"
                  :"ステータス面での評価が高く、婚活市場で有利な立ち位置にいます。自信を持って活動できるポイントです。",
                HUMAN: insight.bestV>=60
                  ?"人間力がとても高く、お相手に安心感を与えられるタイプです。婚活において最大の武器になります。"
                  :"人間力が高く、コミュニケーションの面でアドバンテージがあります。お見合いの場で好印象を残せるタイプです。",
                LITERACY: insight.bestV>=60
                  ?"婚活への姿勢や考え方がとてもしっかりしており、効率的に成婚を目指せるタイプです。"
                  :"婚活に対する考え方や姿勢がしっかりしており、地に足のついた活動ができる方です。",
                LIFE: insight.bestV>=60
                  ?"自分磨きや日々の生活への意識がとても高く、魅力的なライフスタイルが大きな強みです。"
                  :"ライフスタイルや自分磨きへの意識が高く、内面・外面ともに魅力を感じてもらいやすいタイプです。",
                TIMING: insight.bestV>=60
                  ?"婚活を始めるタイミングとして今がベスト。市場での優位性が高い時期です。この勢いを活かしましょう。"
                  :"婚活のタイミングとして良い時期にいます。今の行動力を維持すれば、良いご縁に恵まれやすいです。",
              }[insight.best]}
            </p>
          </div>
          ...
          <div style={{background:"rgba(139,80,112,0.05)",borderRadius:14,padding:"16px 14px",marginBottom:12,border:"1px solid rgba(139,80,112,0.08)"}}>
            ...
            <p style={{fontSize:13,color:"#5A3050",margin:0,lineHeight:1.7}}>
              {{
                SPEC:  insight.worstV<=45
                  ?"ステータス面では現状のスコアに伸びしろがあります。ただし、プロフィールの見せ方次第で印象は大きく変わります。"
                  :"ステータス面を少し強化できると、さらに上のランクが見えてきます。",
                HUMAN: insight.worstV<=45
                  ?"コミュニケーションや共感力の面に伸びしろがあります。ちょっとしたコツで大きく改善できるポイントです。"
                  :"人間力をもう少し磨くと、お見合いでの印象がさらに良くなります。",
                LITERACY: insight.worstV<=45
                  ?"婚活への向き合い方に改善の余地があります。正しい知識と戦略を持つだけで結果が大きく変わります。"
                  :"婚活リテラシーを少し高めると、活動の効率がぐっと上がります。",
                LIFE: insight.worstV<=45
                  ?"ライフスタイルや自分磨きの面に伸びしろがあります。少しの変化で、お相手からの印象が大きく変わるポイントです。"
                  :"日々の生活や自分磨きを少し意識するだけで、より魅力的に映るようになります。",
                TIMING: insight.worstV<=45
                  ?"婚活のタイミングとして、早めの行動が重要です。今すぐ動き出すことで選択肢が大きく広がります。"
                  :"婚活を始める時期として、今がまさに動きどき。タイミングを逃さないことが成功の鍵です。",
              }[insight.worst]}
            </p>
          </div>
