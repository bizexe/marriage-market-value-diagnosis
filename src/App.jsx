      ...
      <div style={wrap}>
        ...
        <div style={{...card,padding:"32px 22px"}}>
          ...
          <div style={{display:"flex",alignItems:"flex-end",gap:8,marginBottom:12,justifyContent:"center"}}>
            ...
            <Bubble text="詳しい改善プラン、一緒に考えよう！" dir="left"/>
          </div>
          ...
          <div style={{display:"flex",gap:8,marginTop:16}}>
            <button style={{
              flex:1,padding:"11px",borderRadius:12,border:"1.5px solid rgba(255,183,197,0.35)",
              background:"rgba(255,255,255,0.7)",color:"#5A3050",fontSize:12,fontWeight:600,
